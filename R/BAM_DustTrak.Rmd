...
Dustrak11 <- read_csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/2019_08_13_h173313_CSTEP_DT809_8530.csv", skip = 28)
Dustrak11 <- Dustrak11 %>%
...
Dustrak12 <- read_csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/2019_08_30_h134429_CSTEP_DT809_8530.csv", skip = 28)
Dustrak12 <- Dustrak12 %>%
...
Dustrak21 <- read_csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/2019_08_13_h173158_CSTEP_DT811_8530.csv", skip = 28)
Dustrak22 <- read_csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/2019_08_30_h134437_CSTEP_DT811_8530.csv", skip = 28)
...
Dustrak11 <- read_csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/2019_08_13_h173309_CSTEP_DT602_8533.csv", skip = 28)
Dustrak12 <- read_csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/2019_08_30_h134435_CSTEP_DT602_8533.csv", skip = 28)
Dustrak1 <- rbind(Dustrak11, Dustrak12)
Dustrak1 <- Dustrak1 %>%
...
Dustrak21 <- read_csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/2019_08_13_h173246_CSTEP_DT603_8533.csv", skip = 28)
Dustrak22  <- read_csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/2019_08_30_h134439_CSTEP_DT603_8533.csv", skip = 28)
...
dir <- "D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/BAM_files/"
# CSTEP_BAM.CSV
df_bam_1hr <- data.frame()
shp_list1 <- list.files(dir, pattern = "\\.CSV$")
for (fil in (shp_list1)) {
  bam <- read.csv(paste0("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/BAM_files/", fil), skip = 4)#BAM skip 5 for UT BAM
  bam <- bam %>%
...
df_bam1_1hr <- read.csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/UT_BAM.CSV", sep = ",", skip = 4)
df_bam1_1hr <- df_bam1_1hr %>%
    mutate(date = as.POSIXct(Time, format='%Y-%m-%d  %H:%M:%S', tz = "Asia/Kolkata")) %>%
    select(date, "BAM1022-131" = ConcHR.ug.m3., "RT_BAM" = ConcRT.ug.m3., "FRH" = FRH..., "Status" = Status)
bam1 <- read.csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/UT_BAM_DATA.CSV", sep = ",", skip = 4)
bam1 <- bam1 %>%
    mutate(date = as.POSIXct(Time, format='%d-%m-%Y  %H:%M', tz = "Asia/Kolkata")) %>%
    select(date, "BAM1022-131" = ConcHR.ug.m3., "RT_BAM" = ConcRT.ug.m3., "FRH" = FRH..., "Status" = Status)
bam1 <- filter(bam1, (month(date) > 06))
bam2 <- read.csv("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/DT112744.CSV", sep = ",", skip = 4)
...
dir <- "D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/Met/"
files <- list.files(dir, pattern = "\\.CSV$")
df <- data.frame()
for(each_file in (files)) {
  met_one <- read.csv(paste("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/Met/", each_file, sep = ""), skip = 1)
  df <- rbind(df, met_one)
}
...
dir <- "D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/DT/"
shp_list <- list.files(dir, pattern = "\\.csv$")
for (file in (shp_list)) {
  Dustrak1 <- read.csv(paste("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/DT/", file, sep = ""), skip = 28)
  Dustrak1 <- Dustrak1 %>%
...
df_bam_1hr <- data.frame()
dir <- "D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/BAM_DT_files/"
shp_list1 <- list.files(dir, pattern = "\\.CSV$")
for (fil in (shp_list1)) {
  bam <- read.csv(paste("D:/Dropbox/ILKConsultancy/dustTrak_colocation/data/BAM_DT_files/", fil, sep = ""), skip = 4)#BAM skip 5 for UT BAM
  df_bam_1hr <- rbind(df_bam_1hr, bam)
}
df_bam_1hr <- df_bam_1hr %>%
  mutate(date = as.POSIXct(Time, format = '%Y-%m-%d %H:%M:%S', tz = "Asia/Kolkata")) %>%
